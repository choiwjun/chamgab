...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=int(os.getenv("LAND_PRICE_TRANSIENT_STORM_MIN_SAMPLES", "100") or 100),
    )
    parser.add_argument(
        "--transient-storm-rate-pct",
        type=float,
        default=float(os.getenv("LAND_PRICE_TRANSIENT_STORM_RATE_PCT", "95") or 95.0),
    )
    parser.add_argument(
        "--transient-storm-max-success-count",
        type=int,
        default=int(os.getenv("LAND_PRICE_TRANSIENT_STORM_MAX_SUCCESS_COUNT", "0") or 0),
    )
    parser.add_argument(
        "--soft-fail",
        action="store_true",
    ...
    for parcel in parcels:
        ...
        if should_stop_for_transient_storm(
            ...
            LOG.info(
                "Stopping collect_land_prices early due to transient storm: "
