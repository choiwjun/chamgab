...
| 메트릭                                    | 값               | 평가    |
| ----------------------------------------- | ---------------- | ------- |
| **MAPE** (Mean Absolute Percentage Error) | **12.88%**       | ⚠️ 보통 |
| **R²** (결정계수)                         | **0.9338**       | ✅ 높음 |
| **MAE**                                   | **45,279,112원** | ⚠️ 보통 |
| **RMSE**                                  | **72,363,556원** | ⚠️ 보통 |

**해석:**

- MAPE 12.88%: 평균적으로 실제 가격의 약 12.9% 오차
- R² 0.9338: 모델이 가격 변동의 93.38%를 설명

---

## 2. 신뢰도 평가 (종합 점수: 72/100)
...
- ✅ **일반적인 매물**: 신뢰도 68-75%
- ⚠️ **특수 조건 매물**: 신뢰도 45-55%
- ❌ **신규/데이터 부족 지역**: 신뢰도 35-45%
