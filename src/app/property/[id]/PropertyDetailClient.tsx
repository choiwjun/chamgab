      ...
      if (!res.ok) {
        ...
        const messageByCode =
          errorCode === 'AUTH_REQUIRED'
            ? '로그인이 필요한 기능입니다. 로그인 후 다시 시도해 주세요.'
        ...
        <div className="grid grid-cols-3 divide-x divide-gray-200 border-t border-gray-200">
          ...
          {property.built_year && (
            <div className="px-4 py-5 text-center">
              ...
              <p className="mt-1 text-xs font-medium text-gray-500">준공연도</p>
            </div>
          )}
          {property.floors && (
            <div className="px-4 py-5 text-center">
      ...
      {factors.length > 0 && (
        <div className="mt-2 border-b border-gray-200 bg-white">
          <div className="px-6 py-8">
            ...
            <PriceFactors factors={factors} isLoading={isLoading} />
          </div>
        </div>
      )}
